...
-- Author: Furion
-- DateCreated: 8/16/2017 6:12:08 PM
--------------------------------------------------------------
-- ===========================================================================
...
function ShowCompletedPopup(completedPopup:table)
	...
	print("ShowCompletedPopup triggered.");
	...
	UIManager:QueuePopup( ContextPtr, PopupPriority.Normal);	-- Made low so any Boost popups related will be shown first
...
function ShowCivicCompletedPopup(player:number, civic:number, isCanceled:boolean)
	print("ShowCivicCompletedPopup triggered.");
...
function OnCivicCompleted( player:number, civic:number, isCanceled:boolean)
	print(isCanceled, m_isWaitingToShowPopup, m_isDisabledByTutorial);
